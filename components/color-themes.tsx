export const colorThemes = [
	...
	},
	{
		...
		light: {
			...
			"--primary": "oklch(0.811 0.102 233.1)", // #92C9F2
			"--primary-foreground": "oklch(0.35 0.08 240)",
			"--secondary": "oklch(0.96 0.01 240)",
			"--secondary-foreground": "oklch(0.3 0.05 240)",
			"--muted": "oklch(0.96 0.01 240)",
			"--muted-foreground": "oklch(0.55 0.03 240)",
			"--accent": "oklch(0.92 0.04 233)",
			"--accent-foreground": "oklch(0.3 0.05 240)",
			"--destructive": "oklch(0.577 0.245 27.325)",
			"--border": "oklch(0.92 0.01 240)",
			"--input": "oklch(0.92 0.01 240)",
			"--ring": "oklch(0.811 0.102 233.1)",
			"--chart-1": "oklch(0.811 0.102 233.1)",
			"--chart-2": "oklch(0.7 0.12 245)",
			"--chart-3": "oklch(0.6 0.14 255)",
			"--chart-4": "oklch(0.5 0.16 265)",
			"--chart-5": "oklch(0.4 0.18 275)",
			"--sidebar": "oklch(0.985 0.005 240)",
			"--sidebar-foreground": "oklch(0.25 0.05 240)",
			"--sidebar-primary": "oklch(0.811 0.102 233.1)",
			"--sidebar-primary-foreground": "oklch(1 0 0)",
			"--sidebar-accent": "oklch(0.96 0.01 240)",
			"--sidebar-accent-foreground": "oklch(0.3 0.05 240)",
			"--sidebar-border": "oklch(0.92 0.01 240)",
			"--sidebar-ring": "oklch(0.811 0.102 233.1)",
		},
		dark: {
			...
			"--accent": "oklch(0.3 0.04 233)",
			"--accent-foreground": "oklch(0.985 0 0)",
			"--destructive": "oklch(0.704 0.191 22.216)",
			"--border": "oklch(1 0 0 / 10%)",
			"--input": "oklch(1 0 0 / 15%)",
			"--ring": "oklch(0.7 0.1 233)",
			"--chart-1": "oklch(0.7 0.1 233)",
			"--chart-2": "oklch(0.6 0.12 245)",
			"--chart-3": "oklch(0.5 0.14 255)",
			"--chart-4": "oklch(0.4 0.16 265)",
			"--chart-5": "oklch(0.3 0.18 275)",
			"--sidebar": "oklch(0.18 0.03 240)",
			"--sidebar-foreground": "oklch(0.985 0 0)",
			"--sidebar-primary": "oklch(0.7 0.1 233)",
			"--sidebar-primary-foreground": "oklch(1 0 0)",
			"--sidebar-accent": "oklch(0.25 0.03 240)",
			"--sidebar-accent-foreground": "oklch(0.985 0 0)",
			"--sidebar-border": "oklch(1 0 0 / 10%)",
			"--sidebar-ring": "oklch(0.7 0.1 233)",
		},
	},
];
